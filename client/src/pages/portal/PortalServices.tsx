          ...
          <div>
            ...
            <div className="space-y-4">
              {shippingServices.map((service, index) => (
                <div key={index} className="bg-white dark:bg-card rounded-2xl shadow-sm overflow-hidden">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              {additionalServices.map((service, index) => (
                <div key={index} className="bg-white dark:bg-card rounded-xl p-4 shadow-sm">
