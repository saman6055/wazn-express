...
export const PORTAL_WIDTH_CLASS: Record<PortalWidth, string> = {
  // Phone first, then a tablet-sized column, then a desktop one. Deliberately
  // not full-bleed: a line of text 1,900 pixels wide is not readable, whatever
  // the monitor can do.
  auto: "max-w-lg md:max-w-3xl xl:max-w-5xl",
  phone: "max-w-lg",
  tablet: "max-w-3xl",
  desktop: "max-w-5xl",
};
