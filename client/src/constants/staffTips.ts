...
export const STAFF_TIPS: StaffTip[] = [
  ...
  { id: "tip-4",
    ...
    example: {
      ku: "کڕیار 3 دانە مۆبایل دەنێرێت بەڵام تۆ 1 داخڵ دەکەیت → نرخ بۆ 1 دانە حساب دەکرێت و کۆمپانیا قازانجی 2 دانە لەدەست دەدات.",
  ...
  { id: "tip-8",
    ...
    example: {
      ku: "12 پاکەتت لەبەردەستە بەڵام سیستەم تەنها 11 سکانکراو پیشان دەدات → یەک پاکەت لەبیر کراوە، بیدۆزەرەوە و سکانی بکە پێش داخستن.",
  ...
  { id: "tip-9",
    ...
    example: {
      ku: "بۆکسێک 10kg لەخۆ دەگرێت بە نرخی $7/kg → نرخی گواستنەوە دەبێت $70. پێش ناردن دڵنیابە 70ـە، نەک 60 بەهۆی هەڵەی کێش.",
  ...
  { id: "tip-20",
    ...
    example: {
      ku: "ئاسمانی: تێچوو $4/kg، نرخ $7/kg → قازانج $3 بۆ هەر kg.",
  ...
  { id: "tip-21",
    ...
    example: {
      ku: "باچی ئاسمانی A 7 ڕۆژ گەیشت، باچی ئاسمانی B 12 ڕۆژ → بۆ ئۆردەری بەپەلە، باچی A پێشنیار بکە.",
  ...
  { id: "tip-31",
    ...
    example: {
      ku: "تێبینی دەکەیت کێشی پاکەتی AZ001 بە هەڵە 2kg تۆمار کراوە لەجیاتی 5kg → یەکسەر چاکی بکە پێش ئەوەی بۆکس بنێردرێت.",
  ...
  { id: "tip-32",
    ...
    detail: {
      ku: "لە گواستنەوەدا، نرخ زۆرجار بەپێی کێش (دۆلار بۆ هەر kg) حساب دەکرێت. ئەگەر کێش کەمتر تۆمار بکەیت، کڕیار کەمتر چارج دەکرێت و قازانج لەدەست دەچێت؛ ئەگەر زیاتر بێت، کڕیار زۆر چارج دەکرێت و ناڕازی دەبێت. بۆیە کێش بە دروستی لە تەرازوو وەربگرە و داخڵی بکە.",
      ...
      ar: "في الشحن، يُحتسَب السعر غالباً حسب الوزن (دولار لكل kg). إذا سجّلت الوزن أقل، يُحصَّل العميل أقل ويضيع الربح؛ وإذا أكثر، يُحصَّل أكثر فيستاء. لذا اقرأ الوزن بدقّة من الميزان وأدخِله.",
      zh: "运输中价格通常按重量计算（每 kg 多少美元）。重量录得过低，会少收客户、损失利润；过高则多收客户、令其不满。所以请从秤上准确读取重量并录入。" },
    example: {
      ku: "نرخ $7/kgـە. پاکەتی AZ001 لەسەر تەرازوو 3kgـە → داخڵی بکە؛ ئەگەر بە هەڵە 2kg بنووسیت، کۆمپانیا $7 لەدەست دەدات.",
  ...
  { id: "tip-33",
    ...
    detail: {
      ku: "لە گواستنەوەی ئاسمانیدا، نرخ بەپێی گەورەترینی نێوان «کێشی ڕاستەقینە» و «کێشی قەبارەیی» وەردەگیرێت. کێشی قەبارەیی = (درێژی×پانی×بەرزی) ÷ 6000. ئەگەر قەبارە داخڵ نەکەیت، لەوانەیە کڕیار کەمتر چارج بکرێت و قازانج لەدەست بدەیت.",
    ...
    example: {
      ku: "پاکەتێک 2kg ـە بەڵام 40×30×20cm. کێشی قەبارەیی = (40×30×20)÷6000 = 4kg → نرخ بەسەر 4kg دادەنرێت، نەک 2kg.",
  ...
  { id: "tip-34",
    ...
    example: {
      ku: "کارتۆنێک 1×0.8×0.5 مەتر → CBM = 0.4 m³.",
  ...
  { id: "tip-36",
    ...
    example: {
      ku: "کارتۆنی AZ001 سێ ئۆردەری تێدایە و کێشی 6kgـە بە $7/kg → کرێی گواستنەوە $42 بۆ تەواوی کارتۆنەکە، نەک 3 جار.",
  ...
  { id: "tip-38",
    ...
    example: {
      ku: "15 پاکەتت هەیە بۆ سکانکردن → یەک لەدوای یەک سکانیان بکە؛ پێویست ناکات نێوان هەر سکانێکدا کلیکی خانەکە بکەیت.",
  ...
  { id: "tip-47",
    ...
    example: {
      ku: "ئەمڕۆ 1$ = 7.2¥. ئەگەر نرخی دوێنێ (7.0¥) بەکاربهێنیت بۆ کاڵای 720¥، تێچوو بە هەڵە $102.86 حساب دەکرێت لەجیاتی $100.",
  ...
  { id: "tip-49",
    ...
    example: {
      ku: "ئۆردەری AZ001 نرخی گۆڕاوە. لە مێژوودا دەردەکەوێت: «ئاکام، 2026/06/30، نرخ لە $50 → $45».",
  ...
  { id: "tip-52",
    ...
    example: {
      ku: "بەیانی «مەشاکل» دەکەیتەوە و دەبینیت: 3 ئۆردەری بێ تراکینگ، کڕیار AZ001 قەرزدار، و 1 ئۆردەری $1,300 → یەک بە یەک چارەسەریان بکە.",
  ...
  { id: "tip-53",
    ...
    example: {
      ku: "ئەم هەفتە «سەرکەوتنەکان» پیشان دەدات: کڕیاری ئاکتیفترین AZ001 بە 22 ئۆردەر، قازانجی هەفتە $1,840 → بزانە کام کڕیار گرنگترینە.",
  ...
  { id: "tip-54",
    ...
    example: {
      ku: "ئەم مانگ سێ باچی دەریایی هەبووە: 28 ڕۆژ، 35 ڕۆژ، 30 ڕۆژ → باچی 35 ڕۆژ دواکەوتووە؛ هۆکارەکەی بپرسە.",
  ...
  { id: "tip-55",
    ...
    example: {
      ku: "کڕیار AZ001 5 ئۆردەری هەیە → یەکجار AZ001 هەڵبژێرە، ئۆردەری یەکەم سەیڤ بکە، فۆرم کراوە دەمێنێتەوە، چوارەکەی دیکەش بەخێرایی داخڵ بکە.",
