...
import { TERMS_WHATSAPP_NUMBER } from "./whatsapp";
    ...
    items: [
      {
        ...
        a: {
          ku: "ئاسمانی خێراترە و بەپێی kg حساب دەکرێت — گونجاوە بۆ بارە سووک و پەلە. دەریایی هەرزانترە و بەپێی مەترسێج (CBM) حساب دەکرێت — گونجاوە بۆ بارە قورس و گەورە کە پەلەت نییە.",
          ...
          ar: "الجوي أسرع ويُحسب بـ kg — مناسب للبضائع الخفيفة والعاجلة. البحري أرخص ويُحسب بالمتر المكعب (CBM) — مناسب للبضائع الثقيلة أو الكبيرة عند عدم الاستعجال.",
          zh: "空运更快，按 kg 计价，适合轻便、紧急的货物。海运更便宜，按立方米（CBM）计价，适合不急的重货或大件货物。",
        },
      },
      {
        q: {
