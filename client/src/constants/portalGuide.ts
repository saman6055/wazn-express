...
export const guideSections: GuideSection[] = [
  ...
  },
  {
    ...
    example: {
      ku: "لانە کارتۆنێکی 5 کگی هەیە بە 40×30×30 — لێرە دەینووسێت و پێش ئەوەی بینێرێت نرخەکە دەزانێت",
      en: "Lana has a 5 kg carton at 40×30×30 — she enters it here and knows the price before sending",
      ar: "لانا لديها كرتون 5 كغ بمقاس 40×30×30 — تدخله هنا وتعرف السعر قبل الإرسال",
