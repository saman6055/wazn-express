...
export const guideSections: GuideSection[] = [
  {
    ...
    example: {
      ku: "دانا پۆرتاڵ دەکاتەوە: دەبینێت 14 پاکەتی لە چینە و 2 لە ڕێگان، و قەرزەکەی $16.93ـە — هەموویان بەبێ سکڕۆڵ",
      en: "Dana opens the portal: 14 parcels in China, 2 on the way, $16.93 owed — all of it without scrolling",
      ar: "تفتح دانا البوابة: 14 طرداً في الصين، 2 في الطريق، و$16.93 مستحقة — كل ذلك دون تمرير",
  ...
  },
  {
    ...
    example: {
      ku: "لانە کارتۆنێکی 5 kg هەیە بە 40×30×30 — لێرە دەینووسێت و پێش ئەوەی بینێرێت نرخەکە دەزانێت",
      en: "Lana has a 5 kg carton at 40×30×30 — she enters it here and knows the price before sending",
      ar: "لانا لديها كرتون 5 kg بمقاس 40×30×30 — تدخله هنا وتعرف السعر قبل الإرسال",
      zh: "拉娜有一个 5 kg、40×30×30 的纸箱——在这里输入即可在发货前知道价格",
    },
  },
  {
    id: "search",
  ...
  },
  {
    ...
    example: {
      ku: "ژیار 10 کارتۆن کاڵای لە تاوباو کڕیوە و ناردوویەتییە کۆگاکەمان — لێرە دەبینێت بارەکەی سبەی دەگاتە سلێمانی",
      ...
      ar: "زيار اشترى 10 كراتين من تاوباو وأرسلها لمخزننا — هنا يرى أن شحنته تصل السليمانية غداً",
  ...
  },
  {
    ...
    example: {
      ku: "هێمن پانتۆڵێکی بە عمولە کڕیوە — لە دارایی یەک کارت دەبینێت: کاڵا 20$ + عمولە 3$ + گواستنەوە 7$ = 30$، نەک سێ وەصڵی لێکترازاو",
      ...
      ar: "هيمن اشترى بنطالاً بالعمولة — في المالية يرى بطاقة واحدة: السلعة 20$ + العمولة 3$ + الشحن 7$ = 30$، وليس ثلاثة إيصالات متفرقة",
  ...
  },
  {
    ...
    example: {
      ku: "ڕێبوار دەبێ 640 یوان بداتە فرۆشیارێک لە چین — لێرە 100$ دەدات، ئێمە یوانەکە دەنێرین بۆ Alipay ی فرۆشیارەکەی",
      en: "Rebwar must pay a Chinese seller ¥640 — he pays $100 here and we send the yuan to the seller's Alipay",
      ar: "ريبوار يجب أن يدفع لبائع صيني 640 يوان — يدفع 100$ هنا ونرسل اليوان إلى Alipay البائع",
  ...
  },
  {
    ...
    points: [
      { ku: "3 پۆل: قەدەغەی تەواو / سنووردار / پێویست بە مۆڵەت", en: "3 groups: fully banned / restricted / needs permit", ar: "3 فئات: ممنوع تماماً / مقيّد / يحتاج تصريحاً", zh: "3类：完全禁止/受限/需要许可" },
