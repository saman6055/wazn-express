  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        party: "you",
        text: {
          ku: "ئەگەر چەندین شتی بچووکت لە یەک کارتۆندا هەبوو، تکایە لەبیرت بێت کرێی گواستنەوە بەپێی کارتۆنی تەواو حیساب دەکرێت، نەک بەپێی ژمارەی ئەو شتانەی ناوی. لە هێڵی ئاسمانیدا هەمیشە گەورەترین لە نێوان کێشی ڕاستەقینە و کێشی قەبارەیی حیساب دەکرێت — بۆ نموونە ئەگەر بارێک کێشی 5 کیلۆ بێت بەڵام کێشی قەبارەیی 10 کیلۆ بێت، ئەوا 10 کیلۆ حیساب دەکرێت. تکایە پێش ناردن لەسەر کێش و قەبارەی بارەکەت لەگەڵمان لەسەر هێڵ بە.",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        party: "us",
        text: {
          ku: "ئەگەر بارێک بزر بێت، قەرەبووەکە بەپێی کێشی بارەکە حیساب دەکرێت: بۆ هەر کیلۆیەک لە بارگەی ئاسمانی تا 25 دۆلار، و بۆ هەر مەتر سێجایەک لە بارگەی دەریایی تا 400 دۆلار. بۆ نموونە، پاکەتێکی 2 کیلۆیی تا 50 دۆلاری بۆ دەدرێتەوە.",
      ...
      },
      {
        party: "us",
        text: {
          ku: "دوو نموونە بۆ ڕوونکردنەوە: کاڵایەکی 2 کیلۆیی کە 30 دۆلاری تێچووە — سنوورەکە 50 دۆلارە، بەڵام نرخی کاڵاکە 30 دۆلارە، بۆیە 30 دۆلارت دەدەینەوە. کاڵایەکی 2 کیلۆیی کە 500 دۆلاری تێچووە — سنوورەکە 50 دۆلارە، بۆیە 50 دۆلارت دەدەینەوە؛ ئەمە ئەو حاڵەتەیە کە بیمە پێویستە.",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        party: "us",
        text: {
          ku: "بارگەی ئاسمانی بەپێی کێشی ڕاستەقینە یان کێشی قەبارەیی حیساب دەکرێت، کامەیان گەورەتر بێت. کەمترین بڕی حیسابکراو 1 کیلۆیە — واتە پاکەتێکی 200 گرامیش وەک 1 کیلۆ حیساب دەکرێت، چونکە هێڵەکانی فڕۆکەوانی بەم شێوەیە لە ئێمە وەردەگرن.",
