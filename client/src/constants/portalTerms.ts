...
export const termsHeader = {
  ...
  updated: {
    ku: "دوایین نوێکردنەوە: 2026/07/31",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        party: "you",
        text: {
          ku: "ئەگەر چەندین شتی بچووکت لە یەک کارتۆندا هەبوو، تکایە لەبیرت بێت کرێی گواستنەوە بەپێی کارتۆنی تەواو حیساب دەکرێت، نەک بەپێی ژمارەی ئەو شتانەی ناوی. لە هێڵی ئاسمانیدا هەمیشە گەورەترین لە نێوان کێشی ڕاستەقینە و کێشی قەبارەیی حیساب دەکرێت — بۆ نموونە ئەگەر بارێک کێشی 5 kg بێت بەڵام کێشی قەبارەیی 10 kg بێت، ئەوا 10 kg حیساب دەکرێت. تکایە پێش ناردن لەسەر کێش و قەبارەی بارەکەت لەگەڵمان لەسەر هێڵ بە.",
          ...
          ar: "إن كان لديك عدّة أغراض صغيرة في كرتونة واحدة، فتذكّر رجاءً أن الشحن يُحتسب على الكرتونة كاملة، لا على عدد الأغراض داخلها. وفي الشحن الجوي يُعتمد دائمًا الأكبر بين الوزن الفعلي والوزن الحجمي — فمثلًا شحنة وزنها 5 kg لكن وزنها الحجمي 10 kg تُحتسب 10 kg. تواصل معنا رجاءً بشأن الوزن والحجم قبل الإرسال.",
          zh: "若一个纸箱内有多件小物品，请记住运费按整箱计算，而不是按里面有多少件。空运始终按实际重量与体积重量中的较大者计费——例如实重 5 kg、体积重 10 kg 的货物，按 10 kg 计费。寄件前请就重量和尺寸与我们沟通。",
        },
      },
      {
        party: "us",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        party: "us",
        text: {
          ku: "ئەگەر بارێک بزر بێت، قەرەبووەکە بەپێی کێشی بارەکە حیساب دەکرێت: بۆ هەر kg لە بارگەی ئاسمانی تا 25 دۆلار، و بۆ هەر مەتر سێجایەک لە بارگەی دەریایی تا 400 دۆلار. بۆ نموونە، پاکەتێکی 2 kg تا 50 دۆلاری بۆ دەدرێتەوە.",
          ...
          ar: "إذا فُقدت شحنة، يُحتسب التعويض على وزنها: حتى 25 دولارًا لكل kg جوًّا، وحتى 400 دولار لكل متر مكعّب بحرًا. فطردٌ وزنه 2 kg يُغطّى حتى 50 دولارًا.",
          zh: "若货物丢失，赔偿按其重量计算：空运每 kg 最高 25 美元，海运每立方米最高 400 美元。因此一件 2 kg 的包裹最高赔付 50 美元。",
        },
      },
      {
        party: "you",
      ...
      },
      {
        party: "us",
        text: {
          ku: "دوو نموونە بۆ ڕوونکردنەوە: کاڵایەکی 2 kg کە 30 دۆلاری تێچووە — سنوورەکە 50 دۆلارە، بەڵام نرخی کاڵاکە 30 دۆلارە، بۆیە 30 دۆلارت دەدەینەوە. کاڵایەکی 2 kg کە 500 دۆلاری تێچووە — سنوورەکە 50 دۆلارە، بۆیە 50 دۆلارت دەدەینەوە؛ ئەمە ئەو حاڵەتەیە کە بیمە پێویستە.",
          ...
          ar: "مثالان: غرض وزنه 2 kg كلّف 30 دولارًا — الحدّ 50 دولارًا، لكن قيمته 30 دولارًا، فندفع لك 30 دولارًا. وغرض وزنه 2 kg كلّف 500 دولار — الحدّ 50 دولارًا، فندفع لك 50 دولارًا؛ وهذه هي الحالة التي يلزم فيها التأمين.",
          zh: "两个例子。一件 2 kg、价值 30 美元的物品：上限 50 美元，但物品价值 30 美元，所以赔您 30 美元。一件 2 kg、价值 500 美元的物品：上限 50 美元，所以赔您 50 美元——这正是需要保险的情形。",
        },
      },
      {
        party: "you",
      ...
      },
      {
        party: "you",
        text: {
          ku: "بۆ داواکردنی قەرەبوو، دوو شت پێویستە: پسووڵەی کڕینەکەت، و پەیوەندیکردن لە ماوەی 7 ڕۆژ دوای وەرگرتنی بارەکە.",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        party: "us",
        text: {
          ku: "بارگەی ئاسمانی بەپێی کێشی ڕاستەقینە یان کێشی قەبارەیی حیساب دەکرێت، کامەیان گەورەتر بێت. کەمترین بڕی حیسابکراو 1 kg — واتە پاکەتێکی 200 گرامیش وەک 1 kg حیساب دەکرێت، چونکە هێڵەکانی فڕۆکەوانی بەم شێوەیە لە ئێمە وەردەگرن.",
          ...
          ar: "يُحتسب الشحن الجوي بالوزن الفعلي أو الحجمي، أيّهما أكبر. والحد الأدنى للاحتساب 1 kg — أي أن طردًا وزنه 200 غرام يُحتسب كيلوغرامًا واحدًا، لأن شركات الطيران تحاسبنا هكذا.",
          zh: "空运按实际重量或体积重量中的较大者计费。最低计费为 1 kg——即使 200 克的包裹也按 1 kg 计算，因为航空公司就是这样向我们收费的。",
        },
      },
      {
        party: "you",
      ...
      },
      {
        party: "us",
        text: {
          ku: "بارگەی دەریایی بەپێی قەبارە حیساب دەکرێت (مەتر سێجا / CBM)، نەک بەپێی کێش. کەمترین بڕی حیسابکراو 0.25 مەتر سێجایە. قەبارە بەم شێوەیە دەرهێنراوە: درێژی × پانی × بەرزی.",
      ...
      },
      {
        party: "us",
        text: {
          ku: "ئەگەر بارێک تا 30 ڕۆژ وەرنەگیرا و هیچ پەیوەندییەکیش نەکرا، ناچار دەبین بیفرۆشین بۆ داپۆشینی ئەو بڕەی ماوەتەوە. پێش ئەو هەنگاوە چەند جارێک لە پۆرتاڵ و لە واتساپ ئاگادارت دەکەینەوە — هەرگیز بەبێ ئاگادارکردنەوە ئەو کارە ناکەین.",
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        party: "us",
        text: {
          ku: "کاتێ بارەکەت گەیشتە هەولێر، دەستبەجێ ئاگادارت دەکەینەوە. 4 ڕۆژی یەکەم بەخۆڕاییە بۆ خەزنکردن.",
      ...
      },
      {
        party: "you",
        text: {
          ku: "تکایە لە ماوەی ئەو 4 ڕۆژەدا وەریبگرە. دوای ئەوە کرێی خەزنکردنی ڕۆژانە دەست پێدەکات، چونکە شوێنی کۆگا سنووردارە و بارەکانی تریش پێویستیان بە جێگایە. ئەگەر ناتوانیت بێیت، تەنها پێمان بڵێ.",
      ...
      },
      {
        party: "us",
        text: {
          ku: "ئەگەر بارێک ماوەیەکی درێژ وەرنەگیرا، پێش هەر هەنگاوێک چەند جارێک لە پۆرتاڵ و لە واتساپ ئاگادارت دەکەینەوە. تەنها دوای 30 ڕۆژ و دوای ئاگادارکردنەوەی کۆتایی، ناچار دەبین بیفرۆشین.",
