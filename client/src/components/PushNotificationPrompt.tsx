...
export function PushNotificationPrompt({ enabled }: { enabled: boolean }) {
  ...
  return (
    <div className="fixed bottom-[calc(6.5rem+env(safe-area-inset-bottom))] start-3 end-3 z-[60] mx-auto max-w-md rounded-2xl border border-emerald-500/30 bg-white/95 p-4 shadow-2xl backdrop-blur dark:bg-slate-900/95 sm:bottom-6 sm:start-auto sm:end-6">
