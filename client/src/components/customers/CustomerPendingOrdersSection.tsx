        ...
        {count === 0 ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div className="p-4 rounded-xl bg-gradient-to-br from-blue-50 dark:from-blue-950/40 to-blue-100 dark:to-blue-900/40 border border-blue-200 dark:border-blue-800/60">
              ...
              <div className="p-4 rounded-xl bg-gradient-to-br from-emerald-50 dark:from-emerald-950/40 to-emerald-100 dark:to-emerald-900/40 border border-emerald-200 dark:border-emerald-800/60">
              ...
              <div className="p-4 rounded-xl bg-gradient-to-br from-purple-50 dark:from-purple-950/40 to-purple-100 dark:to-purple-900/40 border border-purple-200 dark:border-purple-800/60">
