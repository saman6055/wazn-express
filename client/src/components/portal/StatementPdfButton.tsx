  ...
  return (
    <>
      <button
        ...
        className={cn(
          "relative tap-44 inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-2.5 text-sm font-bold text-white shadow-sm transition hover:bg-indigo-700 active:scale-95",
          className,
        )}
      >
