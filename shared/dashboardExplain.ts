...
const FIGURES: Record<DashboardFigureId, DashboardFigureMeta> = {
  todayIncome: {
    ...
    window: {
      ku: "لە 00:00ی ئەمڕۆوە تا ئێستا. بەراورد لەگەڵ هەموو دوێنێ",
      en: "From 00:00 today until now. Compared against the whole of yesterday",
      ar: "من الساعة 00:00 اليوم حتى الآن. مقارنة بيوم أمس كاملاً",
  ...
  weekIncome: {
    ...
    formula: RECEIVED_NOT_INVOICED,
    window: {
      ku: "7 ڕۆژی ڕابردوو — نەک لە شەممەوە. بەراورد لەگەڵ 7 ڕۆژی پێش ئەوان",
      en: "The last 7 days, rolling — not from Saturday. Compared against the 7 days before those",
      ar: "آخر 7 أيام متتالية — وليس من السبت. مقارنة بالأيام السبعة التي قبلها",
  ...
  newCustomers: {
    id: "newCustomers",
    label: { ku: "کڕیاری نوێ (7 ڕۆژ)", en: "New customers (7 days)", ar: "عملاء جدد (7 أيام)", zh: "新客户（7天）" },
    kind: "count",
    formula: {
      ku: "ئەو هەژمارانەی لە 7 ڕۆژی ڕابردوودا دروستکراون — چالاک بن یان نا",
      en: "Accounts created in the last 7 days, active or not",
      ar: "الحسابات المنشأة خلال آخر 7 أيام، نشطة كانت أم لا",
