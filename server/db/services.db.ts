  ...
  const defaultTemplates: InsertNotificationTemplate[] = [
    {
      ...
      isActive: true,
      smsTemplate: "پاکەتەکەت بە ژمارەی {trackingNumber} وەرگیرا. وەزن ئێکسپرێس",
      smsTemplateKu: "پاکەتەکەت بە ژمارەی {trackingNumber} وەرگیرا. وەزن ئێکسپرێس",
      smsTemplateAr: "تم استلام طردك رقم {trackingNumber}. وزن اكسبريس",
    ...
    },
    {
      ...
      isActive: true,
      smsTemplate: "پاکەتەکەت بە ژمارەی {trackingNumber} ڕەوانە کرا بۆ عێراق. وەزن ئێکسپرێس",
      smsTemplateKu: "پاکەتەکەت بە ژمارەی {trackingNumber} ڕەوانە کرا بۆ عێراق. وەزن ئێکسپرێس",
      smsTemplateAr: "تم شحن طردك رقم {trackingNumber} الى العراق. وزن اكسبريس",
    ...
    },
    {
      ...
      isActive: true,
      smsTemplate: "پاکەتەکەت بە ژمارەی {trackingNumber} گەیشتە کۆگای سلێمانی. وەزن ئێکسپرێس",
      smsTemplateKu: "پاکەتەکەت بە ژمارەی {trackingNumber} گەیشتە کۆگای سلێمانی. وەزن ئێکسپرێس",
      smsTemplateAr: "وصل طردك رقم {trackingNumber} الى مخزن السليمانية. وزن اكسبريس",
    ...
    },
    {
      ...
      isActive: true,
      smsTemplate: "پاکەتەکەت بە ژمارەی {trackingNumber} گەیاندرا. سوپاس بۆ متمانەت! وەزن ئێکسپرێس",
      smsTemplateKu: "پاکەتەکەت بە ژمارەی {trackingNumber} گەیاندرا. سوپاس بۆ متمانەت! وەزن ئێکسپرێس",
      smsTemplateAr: "تم توصيل طردك رقم {trackingNumber}. شكراً لثقتك! وزن اكسبريس",
    ...
    },
    {
      ...
      isActive: true,
      smsTemplate: "پارەدانی ${amount} وەرگیرا. باڵانسی نوێ: ${balance}. وەزن ئێکسپرێس",
      smsTemplateKu: "پارەدانی ${amount} وەرگیرا. باڵانسی نوێ: ${balance}. وەزن ئێکسپرێس",
      smsTemplateAr: "تم استلام دفعة ${amount}. الرصيد الجديد: ${balance}. وزن اكسبريس",
    ...
    },
    {
      ...
      name: "Batch Shipped",
      isActive: true,
      smsTemplate: "باچی {batchNumber} ڕەوانە کرا. {packageCount} پاکەتت تێدایە. وەزن ئێکسپرێس",
      smsTemplateKu: "باچی {batchNumber} ڕەوانە کرا. {packageCount} پاکەتت تێدایە. وەزن ئێکسپرێس",
      smsTemplateAr: "تم شحن الدفعة {batchNumber}. لديك {packageCount} طرود. وزن اكسبريس",
    ...
    },
    {
      ...
      name: "Batch Arrived",
      isActive: true,
      smsTemplate: "باچی {batchNumber} گەیشت. {packageCount} پاکەتت ئامادەیە بۆ وەرگرتن. وەزن ئێکسپرێس",
      smsTemplateKu: "باچی {batchNumber} گەیشت. {packageCount} پاکەتت ئامادەیە بۆ وەرگرتن. وەزن ئێکسپرێس",
      smsTemplateAr: "وصلت الدفعة {batchNumber}. لديك {packageCount} طرود جاهزة للاستلام. وزن اكسبريس",
      pushTitle: "باچ گەیشت",
