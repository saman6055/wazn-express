    ...
    try {
      await createCustomerNotification({
        ...
        messageKu:
          ...
          `ئەم زیادەیە هی هێڵی ئاسمانییە نەک هی ئێمە. ئەگەر پرسیارت هەبوو، لە ماوەی 24 کاتژمێردا پەیوەندیمان پێوە بکە.`,
        messageAr:
          ...
          `هذه الزيادة من شركة الطيران وليست منّا. تواصل معنا خلال 24 ساعة لأي استفسار.`,
      }, { push: true });
    } catch (err) {
